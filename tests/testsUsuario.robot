...
Cenário de testes 02: Clicar no botão CADASTROS
    Logar com sysadmin: Digitar um e-mail Valido
    Logar com sysadmin: Digitar Uma Senha Valida 
    Logar com sysadmin: Clicar No Botao Entrar
    Logar com sysadmin: Verificar Se Realmente Entrou No Sistema 
...
Cenário de testes 05: Verificar FORM CADASTRO       
    Logar com sysadmin: Digitar um e-mail Valido
    Logar com sysadmin: Digitar Uma Senha Valida 
    Logar com sysadmin: Clicar No Botao Entrar
    Logar com sysadmin: Verificar Se Realmente Entrou No Sistema 
...
Cenário de tests 06: Clicar para cadastrar NOME COMPLETO 
    Logar com sysadmin: Digitar um e-mail Valido
    Logar com sysadmin: Digitar Uma Senha Valida 
    Logar com sysadmin: Clicar No Botao Entrar
    Logar com sysadmin: Verificar Se Realmente Entrou No Sistema 
...
Cenário de tests 07: Clicar para cadastrar EMAIL
    Logar com sysadmin: Digitar um e-mail Valido
    Logar com sysadmin: Digitar Uma Senha Valida 
    Logar com sysadmin: Clicar No Botao Entrar
    Logar com sysadmin: Verificar Se Realmente Entrou No Sistema 
...
Cenário de tests 08: Clicar para cadastrar PERFIL DE ACESSO
    Logar com sysadmin: Digitar um e-mail Valido
    Logar com sysadmin: Digitar Uma Senha Valida 
    Logar com sysadmin: Clicar No Botao Entrar
    Logar com sysadmin: Verificar Se Realmente Entrou No Sistema 
...
Cenário de tests 09: Clicar para cadastrar CPF
    Logar com sysadmin: Digitar um e-mail Valido
    Logar com sysadmin: Digitar Uma Senha Valida 
    Logar com sysadmin: Clicar No Botao Entrar
    Logar com sysadmin: Verificar Se Realmente Entrou No Sistema 
...
Cenário de tests 10: Clicar para SALVAR NOVO
    Logar com sysadmin: Digitar um e-mail Valido
    Logar com sysadmin: Digitar Uma Senha Valida 
    Logar com sysadmin: Clicar No Botao Entrar
    Logar com sysadmin: Verificar Se Realmente Entrou No Sistema 
